...
import { Avatar, Dropdown, DropdownHeader, DropdownDivider, DropdownItem } from 'flowbite-react';
    ...
    <Dropdown
      ...
      label={
        <Avatar
          ...
          rounded
          className="ring-emerald-200 ring-offset-2"
        />
      }
    >
      <DropdownHeader>
      ...
      <DropdownItem onClick={() => navigate('/setup')}>Re-run setup</DropdownItem>
      <DropdownDivider />
